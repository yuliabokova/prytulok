...
**Primary persona:** Маша — хоче першу тварину, прийшла з Instagram, ще не певна. Має всі 5 блокерів (Б1–Б5): розмиті фото, безособовий опис, немає compatibility-міток, страх дзвінка (30-хв інтерв'ю Sirius + ризик відмови), тиша після форми.

**Main job:** Коли я побачила тварину і вирішую чи вона для мене, я хочу отримати відповідь «моя / не моя» без дзвінків і невизначеності, щоб зробити рішення з впевненістю і не відкласти на потім.

**Топ-3 jobs для MVP** (П1=3, не закриті UA-конкурентами Happy Paw / Sirius):
1. **R2** — Зрозуміти тварину: named caretaker «Волонтер Оля знає Мурку 3 тижні» + поведінковий портрет
2. **R4** — Знати що буде після: сторінка підтвердження + email із дедлайном відповіді
3. **R1** — Швидке сортування: compatibility-мітки іконками прямо на картці (квартира / діти / інші тварини)

→ Повний контекст: [research/personas.md](./research/personas.md) · [research/jtbd.md](./research/jtbd.md)
